...
public class RenderAdamMob extends RenderLiving
{
    private static final ResourceLocation zombieTextures = new ResourceLocation("textures/entity/zombie/AdamMob.png");
    /** Scale of the model to use */
    private float scale;
    private static final String __OBFID = "CL_00000998";

    public RenderAdamMob(ModelBase par1ModelBase, float par2, float par3)
    {
